...
class TranslationTask(FairseqTask):
    ...
    def prune_step(self, sample, model, criterion):
        ...
        [i.self_attn_variables["context"].retain_grad() for i in model.encoder.layers]
        [i.self_attn_variables["context"].retain_grad() for i in model.decoder.layers]
        [i.encoder_attn_variables["context"].retain_grad() for i in model.decoder.layers]
